...
const RecommendationChart: React.FC<RecommendationChartProps> = ({
  ...
  const chartData = [
    {
      name: "Protein",
      population: Math.round((protein / total) * 100),
      color: "#4CAF50",
    ...
    {
      name: "Carbs",
      population: Math.round((carbs / total) * 100),
      color: "#FFC107",
      legendFontColor: "#7F7F7F",
      legendFontSize: 15,
    },
    {
      name: "Fat",
      population: Math.round((fat / total) * 100),
      color: "#F44336",
      legendFontColor: "#7F7F7F",
      legendFontSize: 15,
    },
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.detailText}>
          Total Fat: {detailedNutrition.totalFat}
        </Text>
        <Text style={styles.detailText}>
          Saturated Fat: {detailedNutrition.saturatedFat}
        </Text>
        <Text style={styles.detailText}>
          Trans Fat: {detailedNutrition.transFat}
        </Text>
      </View>
      ...
      {analysisResult && (
        <View style={styles.recommendationContainer}>
          ...
          <Markdown style={styles}>{analysisResult}</Markdown>
        </View>
      )}
    </ScrollView>
  );
